...
class LangGenerator(dataOutput: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
    ...
    override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, translationBuilder: TranslationBuilder) {
        ...
        with(translationBuilder) {
            ...
            add(SkillDisplayWidget.LEVEL, "Level")
            add(SkillWidget.SKILL_LEVEL, "Level %s/%s")
            add(SkillWidget.TOOLTIP, "Click to view unlocks")
            add(SkillScreen.LEVEL, "Level %s")
            add(LockGroupWidget.WidgetTexts.CAN_USE.normal, "Can now use")
            add(LockGroupWidget.WidgetTexts.CAN_USE.additional, "Can use with: %s")
            add(LockGroupWidget.WidgetTexts.CAN_PLACE.normal, "Can now place")
            add(LockGroupWidget.WidgetTexts.CAN_PLACE.additional, "Can place with: %s")
            add(LockGroupWidget.WidgetTexts.CAN_ENCHANT.normal, "Can now enchant with")
            ...
            add(LockedAvailableJobWidget.LOCKED, "Locked Job")
            ...
            add(RequirementTooltip.HINT, "[LShift] to view requirements")
            add(RequirementTooltip.USE, "To Use ")
            add(RequirementTooltip.PLACE, "To Place ")
            add(RequirementTooltip.CRAFT, "To Craft ")
