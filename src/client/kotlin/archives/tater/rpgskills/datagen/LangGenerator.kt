...
class LangGenerator(dataOutput: FabricDataOutput, registryLookup: CompletableFuture<RegistryWrapper.WrapperLookup>) :
    ...
    override fun generateTranslations(registryLookup: RegistryWrapper.WrapperLookup, translationBuilder: TranslationBuilder) {
        ...
        with(translationBuilder) {
            ...
            add(SkillDisplayWidget.SKILL_LEVEL, "%s/%s")
            add(SkillScreen.LEVEL, "Level %s")
            add(LockGroupWidget.Texts.ITEMS, "Item Interactions")
            add(LockGroupWidget.Texts.BLOCKS, "Block Interactions")
            add(LockGroupWidget.Texts.ENTITIES, "Entity Interactions")
            add(LockGroupWidget.Texts.ENCHANTMENTS, "New Enchantments")
            add(LockGroupWidget.Texts.RECIPES, "New Recipes")
