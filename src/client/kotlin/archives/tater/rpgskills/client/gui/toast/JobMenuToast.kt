...
class JobMenuToast(seen: Boolean = false) : TrackedToast(seen) {
    override fun draw(
        context: DrawContext,
        ...
        context.drawTextWrapped(manager.client.textRenderer, TITLE.text(RPGSkillsClient.jobsKey.boundKeyLocalizedText), 30, 7, width - 38, 0xAAAAAA)
    ...
    companion object {
        ...
        val TITLE = Translation.arg("toast.${RPGSkills.MOD_ID}.job_menu")

        val CODEC = createCodec(::JobMenuToast)
    }
}